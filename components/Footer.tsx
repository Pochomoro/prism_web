...
const Footer = () => {
    ...
    return (
        <footer className="relative w-full overflow-hidden">
            {/* ========== VERSION DESKTOP ========== */}
            <div className="hidden md:block bg-gradient-to-b from-purple-800 via-purple-900 to-indigo-950 text-white">
    ...
    <div className="md:hidden bg-gradient-to-b from-purple-800 via-purple-900 to-indigo-950 text-white">
        <div className="px-6 py-12">
            {/* Logo */}
            <div className="text-center mb-8">
                <Link href="/" className="font-title text-white font-semibold text-4xl hover:text-purple-300 transition-colors">
                    PRISM
                </Link>
            ...
            {/* Newsletter Section */}
            <div className="mb-10">
                <h3 className="font-title text-xl font-bold mb-4 text-white text-center">
                    Restez informé
                </h3>
                ...
                <form onSubmit={handleSubscribe} className="space-y-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            onChange={(e) => setEmail(e.target.value)}
                            placeholder="Votre adresse e-mail"
                            className="w-full bg-purple-700/50 backdrop-blur-sm text-white placeholder-purple-300 pl-12 pr-4 py-3 rounded-2xl border border-purple-600/50 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition-all text-sm"
                            required
                        />
                    </div>
                    <button
                        type="submit"
                        className="w-full bg-gradient-to-r from-purple-600 to-purple-800 text-white font-title font-semibold px-6 py-3 rounded-2xl hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2"
                    >
                        S'abonner
                        <Send className="w-4 h-4" />
                    </button>
            ...
            <div className="grid grid-cols-2 gap-8 mb-10">
                {/* Navigation */}
                <div>
                    <h4 className="font-title text-base font-bold mb-4 text-white">Navigation</h4>
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link href="/security" className="text-purple-200 hover:text-white transition-colors text-sm">
                                Sécurité
                            </Link>
                        </li>
                        <li>
                            <Link href="/mission" className="text-purple-200 hover:text-white transition-colors text-sm">
                                Mission
                            </Link>
                        </li>
                        <li>
                            <Link href="/#plans" className="text-purple-200 hover:text-white transition-colors text-sm">
                                Abonnements
                            </Link>
                        </li>
                        <li>
                            <Link href="/#Download" className="text-purple-200 hover:text-white transition-colors text-sm">
                                Télécharger
                            </Link>
                        </li>
                        <li>
                            <Link href="/contact" className="text-purple-200 hover:text-white transition-colors text-sm">
                                Contact
                            </Link>
                        </li>
                    </ul>
                ...
                {/* Légal */}
                <div>
                    <h4 className="font-title text-base font-bold mb-4 text-white">Légal</h4>
                    <ul className="space-y-2">
                        <li>
                            <Link href="/conditions-generales" className="text-purple-200 hover:text-white transition-colors text-sm">
                                CGU
                            </Link>
                        </li>
                        <li>
                            <Link href="/politique-confidentialite" className="text-purple-200 hover:text-white transition-colors text-sm">
                                Confidentialité
                            </Link>
                        </li>
                        <li>
                            <Link href="/faq" className="text-purple-200 hover:text-white transition-colors text-sm">
                                FAQ
                            </Link>
                        </li>
                        <li>
            ...
            {/* Social Media */}
            <div className="text-center mb-8">
                <h4 className="font-title text-base font-bold mb-4 text-white">Suivez-nous</h4>
                <div className="flex justify-center gap-4">
                    ...
                    aria-label="Instagram"
                    >
                    <Instagram className="w-6 h-6 text-purple-200" />
                </a>
                <a
                href="https://facebook.com/prismapp"
                target="_blank"
                ...
                aria-label="Facebook"
                >
                <Facebook className="w-6 h-6 text-purple-200" />
            </a>
            <a
            href="https://twitter.com/prismapp"
            target="_blank"
